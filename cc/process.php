<?php 
	...
	$planID = $_SESSION['CC_planID'];
	$concCurrents = $_SESSION['CC_concurrents']; 
	$apiAccess = $_SESSION['CC_api']; 
	$userID = $_SESSION['ID'];
...
<title><?php echo $sitename;?> - Payment System</title>
...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('<?php echo $stripePubKey; ?>');
...
<form action="" method="POST" id="payment-form" class="form-horizontal">
  ...
  <div class="page-header">
    <h2 class="gdfg"><?php echo $sitename; ?> - Stripe Payment System</h2>
  </div>
  <noscript>
...
if(!(empty($success)))
{
				...
				$SQL -> execute(array(':price' => $price, ':planid' => $planID, ':userid' => $userID, ':payer' => $_POST['email'], ':transactionid' => 'Credit Card Payment'));
  ...
  <fieldset>
    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        <p>Your card will be charged $<?php echo $price; ?> after submit.</p> 
      </div>
    </div>
